    ...
    for (npu_id = 0; npu_id < hal_rt_access_fib_config()->max_num_npu;
        ...
        if (p_fh == NULL) {
            ...
            if (!p_nh) {
                ...
                EV_LOG_TRACE(ev_log_t_ROUTE, 3, "HAL-RT-NDI", "Null NH!");
        ...
        if (!p_dr->a_is_written[npu_id]) {
            ...
            if (rc != STD_ERR_OK) {
                ...
                EV_LOG_TRACE(ev_log_t_ROUTE, 1, "HAL-RT-NDI(RT-END)",
             ...
             */
            EV_LOG_TRACE(ev_log_t_ROUTE, 2, "HAL-RT-NDI(RT-END)",
...
dn_hal_route_err _hal_fib_route_del(uint32_t vrf_id, t_fib_dr *p_dr) {
    ...
    for (npu_id = 0; npu_id < hal_rt_access_fib_config()->max_num_npu;
        ...
        if (rc != STD_ERR_OK) {
            ...
            EV_LOG_TRACE(ev_log_t_ROUTE, 1, "HAL-RT-NDI",
